...
from metamorphic_multifunction_search.operation.extraction.accessions import AccessionManager
...
from metamorphic_multifunction_search.operation.functional.annotation_transfer.sequence_go_annotation import \
